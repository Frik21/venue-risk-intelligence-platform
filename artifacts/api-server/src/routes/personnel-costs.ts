...
// One line per timesheet entry, with its allocated share of that
// period's personnel cost (rate x hours, including any overtime
// premium - see lib/personnel-cost.ts) - powers Costs' Personnel Costs
// section. Deliberately not pre-aggregated server-side so the
// frontend can group by task, by CPO, or by period as needed.
